...
public class LudiiPythonAI extends AI
{
	...
	/** The "ludii_python.kriegspiel_agent" Python Module */
	...
	public void initAI(final Game game, final int playerID)
	{
		...
		if (!initialisedJpy)
		{
			...
			ludiiPythonModule = PyModule.importModule("ludii_python.kriegspiel_agent");
			initialisedJpy = true;
		}		
		
		// Instantiate a new AI (implemented in the Python class "KriegspielAgent")
		pythonAI = ludiiPythonModule.call("KriegspielAgent");
